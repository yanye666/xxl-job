	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "jobStatistic">active</#if>" ><a href="${request.contextPath}/jobStatistic"><i class="fa fa-circle-o text-blue"></i><span>${I18n.jobinfo_statistic_name}</span></a></li>
				<li class="nav-click <#if pageName == "jobForecast">active</#if>" ><a href="${request.contextPath}/jobForecast"><i class="fa fa-circle-o text-orange"></i><span>${I18n.jobinfo_forecast_name}</span></a></li>
